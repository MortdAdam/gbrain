---
name: aas-ask-questions-if-underspecified
description: Clarify requirements before implementing. Use when serious doubts arise.
risk: unknown
source: community
triggers:
  - "aas-ask-questions-if-underspecified"
---
...
- Do not fabricate context, APIs, credentials, external state, or successful execution.
