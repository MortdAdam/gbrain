...
## Contract
- Inputs: platform/API context as documented
- Outputs: structured guidance; no auto-execution

## Output Format
- Markdown guidance / API response summaries

## Anti-Patterns
- Auto-trading or treating platform signals as guaranteed profit
