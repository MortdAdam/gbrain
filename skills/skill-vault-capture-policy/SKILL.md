...
version: 1.0.0
description: |
  Use when Adam wants a durable operational learning, new agent skill, or
...
1. **Classify the learning.**
   ...
   - New Hermes / Herdr / Codex integration fact.
   - New Obsidian vault workflow or structure decision.
   - New recurring agent skill that changes how Ark should operate here.
